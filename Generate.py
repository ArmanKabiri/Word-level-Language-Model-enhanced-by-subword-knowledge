...
def get_args_from_terminal():
    ...
    parser.add_argument('seed_sequence', type=str, help='A sequence given to the model for Tweet generation.')
    parser.add_argument('random_seed', type=int, help='The seed for randomness')
